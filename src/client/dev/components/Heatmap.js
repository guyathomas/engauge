...
import { mergeNArrays, pluckFromSetAtKey, findKeyAtID, scaleData } from '../../assets/scripts';
...
class Heatmap extends React.Component {
  ...
  getSessionsToRender(nextProps) {
    ...
    if (activeStudy) {
      ...
      console.log('The active study', aggregateData)
